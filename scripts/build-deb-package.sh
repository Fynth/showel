...
package_root="${output_dir}/showel_${package_version}_amd64"
deb_path="${output_dir}/showel_${package_version}_amd64.deb"

rm -rf "${package_root}"
mkdir -p "${package_root}/DEBIAN"
mkdir -p "${package_root}/usr/bin"
mkdir -p "${package_root}/usr/lib/showel/assets"
mkdir -p "${package_root}/usr/share/applications"
mkdir -p "${package_root}/usr/share/icons/hicolor/scalable/apps"
mkdir -p "${package_root}/usr/share/doc/showel"
...
install -Dm755 "${project_root}/target/release/app" "${package_root}/usr/bin/showel"
install -Dm644 "${project_root}/app/assets/app.css" \
  "${package_root}/usr/lib/showel/assets/app.css"
install -Dm644 "${project_root}/packaging/arch/showel.desktop" \
  "${package_root}/usr/share/applications/showel.desktop"
install -Dm644 "${project_root}/app/assets/icon.svg" \
  "${package_root}/usr/share/icons/hicolor/scalable/apps/showel.svg"
install -Dm644 "${project_root}/README.md" \
  "${package_root}/usr/share/doc/showel/README.md"
