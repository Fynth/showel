...
#[component]
pub fn AcpAgentPanel(mut panel_state: Signal<AcpPanelState>) -> Element {
            ...
            if state.connected {
                ...
                div { class: "agent-panel__messages",
                    if state.messages.is_empty() {
                        p { class: "empty-state", "Send a prompt to the connected ACP agent." }
                    } else {
                ...
                div { class: "agent-panel__composer",
                    textarea {
                        ...
                        value: "{state.prompt}",
                        placeholder: "Ask the ACP agent about the active database, query, or schema...",
                        oninput: move |event| {
